...
" License: Same as Vim.
"
" Modified by Theofilos Petsios  <theofilos.pe@gmail.com>
"
...
setlocal cindent cinoptions& cinoptions+=(0,j1
...
function GetJavaIndent()
  ...
  if (getline(v:lnum) =~ s:dot_first)
    if (getline(lnum) =~ s:dot_first)
